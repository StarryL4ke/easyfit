					...
					<div class="card shadow mb-4">
						<div class="card-body px-5 py-4">
							...
							<form id='operForm' action="/easyfit/lessonRemove" method="post">
								<input type='hidden' id='prno' name='prno' value='<c:out value="${voVar[0].prno}"/>'>
								<input type='hidden' id='edate' name='edate' value='<fmt:formatDate pattern="yyyy-MM-dd" value="${voVar[0].edate}" />'>
