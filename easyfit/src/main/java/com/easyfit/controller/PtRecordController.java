...
/*
 * @GetMapping(value = "/{prno}", produces =
 * {MediaType.APPLICATION_ATOM_XML_VALUE,
 * MediaType.APPLICATION_JSON_UTF8_VALUE}) public ResponseEntity<LessonJoinVO>
 * get(@PathVariable("prno") Long prno) { log.info("get : " + prno);
 * 
 * return new ResponseEntity<>(clientService.get()) } 
 * 
 */
}
